...
public class MainBlackJack {
    public static void main(String[] args) {
        ...
        String namePlayer = JOptionPane.showInputDialog(null, "Enter your player ID:");
        BlackJack play = new BlackJack(namePlayer);
        play.game();
        JOptionPane.showMessageDialog(null, play.toString());
    }
